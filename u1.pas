...
//Save Configuration Font Name & Size, backup Script etc
...
//to Confirmation before Terminate Application
...
//to Set Highlight Color (Line Position)
...
//Update Caret Position, update like Lagg on lazarus, that's why I use a timer
